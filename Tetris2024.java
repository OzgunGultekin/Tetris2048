...
public class Tetris2048 {
   public static void main(String[] args){
      ...
      // -----------------------------------------------------------------------
      int iterationCount = 1; // used for the speed of the game
      ...
      while (true) {
         ...
         if (StdDraw.isKeyPressed(KeyEvent.VK_LEFT))
        	...
        	currentTetromino.rotateTetromino(currentTetromino.tileMatrix, currentTetromino.tileMatrix.length);
         ...
         // if the down arrow key is being pressed
            ...
            currentTetromino.move("down", grid);
        	 ...
        	 currentTetromino.move("instant-drop", grid);
         
         else if (StdDraw.isKeyPressed(KeyEvent.VK_M)){
        	 grid.displayPauseMenu();
         }
         ...
         grid.mergeNumbers(grid.tileMatrix);
         grid.clearFullLines(grid.tileMatrix);
         grid.colorful(grid.tileMatrix);
         grid.display();
   ...
   public static Tetromino createTetromino() {
      ...
      char[] tetrominoTypes = { 'I', 'O', 'Z','S','T','L','J'};
